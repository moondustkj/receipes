...
const ReceipeCard = ({ receipe, handleBookmark }) => {
    ...
    return <div className='card relative block' onClick={handleNavigate}>
        <img src={receipe.img} alt='receipe-image'
            className='w-full' />
        <div className='bottom'>
            <div className='flex justify-between'>
                ...
                <span className='flex items-center gap-[5px]'>
                    ...
                    <p className='fs-14'>{receipe.time / 60} min</p>
                </span>
            </div>
            <div className='ingredients-wrapper'>
                {
                    receipe.ingredients?.map((ing, i) => (
                        <>
                            ...
                            {i === receipe.ingredients.length - 1 ? '' : <span className='seperator'>
        ...
        <button className='bookmark btn' onClick={(e) => handleBookmark(e, receipe)}>
            {!receipe.isBookmarked ?
